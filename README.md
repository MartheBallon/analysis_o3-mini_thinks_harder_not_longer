...
The DeepSeek-R1 model responses on Omni-MATH (`data/omni_math/other_models/`) and GPQA Diamond (`data/gpqa/other_models/`) were obtained from [Vanhoyweghen et al. (2025)](https://arxiv.org/abs/2508.15842). The gpt-oss-120b responses on GPQA Diamond (`data/gpqa/other_models/responses_gpt_oss_120b.jsonl`) were obtained from [Ballon et al. (2026)](https://arxiv.org/abs/2601.23163).
